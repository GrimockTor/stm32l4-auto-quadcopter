...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
void DRONE::return_to_home(uint8_t go_home) 
{
  ...
  if (flight_mode == 4) {
    ...
    if (go_home == 0) {
      ...
      if (abs(lat_gps_home - l_lat_waypoint) < 90 && abs(lon_gps_home - l_lon_waypoint) < 90)go_home = 3;
      else {
        return_to_home_move_factor = 0.0;
        if (return_to_home_lat_factor == 1 || return_to_home_lon_factor == 1)go_home = 1;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    if (go_home == 1) {
      if (return_to_home_decrease <= 0)go_home = 2;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    if (go_home == 2) {
      if (lat_gps_home == l_lat_waypoint && lon_gps_home == l_lon_waypoint)go_home = 3;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    if (go_home == 3) {
      if (pid_altitude_setpoint > actual_pressure + 150)go_home = 4;
      pid_altitude_setpoint += 0.035;
    }
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
